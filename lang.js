...
const translations = {
  ...
  ln: {
    ...
    heroSubtitle:     'Baavoka, ba klinike, ba garage, ba farmasiye… bayebisami mpe bakitisami na RDC.',
    searchCityDefault:'Ba vile nyonso',
    searchPlaceholder:'Dokoti, garage, restora…',
    searchBtn:        'Koluka',
    sectionTitle:     'Tala na mitindo',
    catLawyers:       'Baavoka',
    catClinics:       'Ba klinike',
    catDentists:      'Badokoti ya mino',
    catGarages:       'Ba garage',
    catGroceries:     'Ba boutiki',
    catPharmacies:    'Ba farmasiye',
    catRestaurants:   'Ba restora',
    catHotels:        'Ba otele',
