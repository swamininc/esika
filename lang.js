...
const translations = {
  ...
  fr: {
    ...
    heroSubtitle:     'Avocats, cliniques, garages, pharmacies… vérifiés et recommandés en RDC et au Canada.',
    ...
    footerBrand:      'kolukela — par Swamin Inc.',
    // Page d'inscription
    navBack:          '← Retour à l\'accueil',
    regTitle:         'Inscrire mon business',
    regSubtitle:      'Remplis ce formulaire pour apparaître sur Kolukela. Ton dossier sera examiné et activé sous 48h par notre équipe.',
  ...
  en: {
    ...
    heroSubtitle:     'Lawyers, clinics, garages, pharmacies… verified and recommended in DRC and Canada.',
    ...
    footerBrand:      'kolukela — by Swamin Inc.',
    // Registration page
    navBack:          '← Back to home',
    regTitle:         'Register my business',
    regSubtitle:      'Fill in this form to appear on Kolukela. Your file will be reviewed and activated within 48 hours.',
  ...
  ln: {
    ...
    navCta:           'Ko komisa biznesi na ngai',
    heroTitle:        'Koluka<br><span class="hero__title--accent">basali</span> ya malamu penepene na yo',
    heroSubtitle:     'Ba Avoka, Lopitalo, ba garage, Magazini Ya Kisi… bayebisami mpe bakitisami na RDC mpe Canada.',
    ...
    footerBrand:      'kolukela — na Swamin Inc.',
    // Lokasa ya koyebisa
    navBack:          '← Zongela na ebandeli',
    regTitle:         'Ko komisa Biznesi na ngai',
    regSubtitle:      'Koma na fomilele oyo mpo ozala na kati ya Kolukela. To Ko tanga yango sima nde o kozala na biso na mikolo mibale',
